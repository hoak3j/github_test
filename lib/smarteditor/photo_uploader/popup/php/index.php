...
$ym = date('ym', HY_SERVER_TIME);

//$data_dir = HY_DATA_PATH.'/editor/'.$ym.'/';
//$data_url = HY_DATA_PATH.'/editor/'.$ym.'/';

$data_dir = HY_DATA_PATH.'/editor/';
$data_url = HY_DATA_PATH.'/editor/';

@mkdir($data_dir, HY_DIR_PERMISSION);
@chmod($data_dir, HY_DIR_PERMISSION);
