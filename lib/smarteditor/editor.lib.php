...
function editor_html($id, $content, $is_dhtml_editor=true)
{
    ...
    $editor_url = HY_EDITOR_URL.'/'.$config['cf_editor'];
    ...
    if ($is_dhtml_editor && $js) {
        ...
        $html .= "\n".'<script>var HY_editor_url = "'.$editor_url.'", oEditors = [], ed_nonce = "'.ft_nonce_create('smarteditor').'";</script>';
...
if (!defined('FT_NONCE_UNIQUE_KEY'))
    define( 'FT_NONCE_UNIQUE_KEY' , sha1(HY_MYSQL_USER) );
